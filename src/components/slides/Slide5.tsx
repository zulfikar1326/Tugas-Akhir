        ...
        <motion.div variants={itemVariants} className="lg:col-span-3 glass-card bg-white/5 border border-white/5 p-4 rounded-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              <span className="text-[20px] uppercase text-slate-400">Tanpa SMOTE</span>
            ...
            <div className="text-center">
              <span className="text-[20px] uppercase text-amber-400">Dengan SMOTE</span>
          ...
          <p className="text-[15px] text-slate-400 mt-3 text-center leading-relaxed">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2 glass-card bg-white/5 border border-white/5 p-4 rounded-2xl flex flex-col justify-center">
          ...
          <div className="space-y-2 text-center">
            <div className="bg-white/5 p-2 rounded-lg border-l-2 border-l-emerald-400">
              <p className="text-[12px] text-slate-200 italic">"Pelayanan sangat ramah!"</p>
              <span className="text-[15px] text-emerald-400 font-bold">✅ Positif (99.9%)</span>
            </div>
            <div className="bg-white/5 p-2 rounded-lg border-l-2 border-l-slate-400">
              <p className="text-[12px] text-slate-200 italic">"Seperti pada Umumnya minimarket lh"</p>
              <span className="text-[15px] text-amber-400 font-bold">⚪ Netral (99.99%) → Model paham konteks!</span>
            </div>
            <div className="bg-white/5 p-2 rounded-lg border-l-2 border-l-red-400">
              <p className="text-[12px] text-slate-200 italic">"Kasir tidak sopan & tidak senyum"</p>
              <span className="text-[15px] text-red-400 font-bold">❌ Negatif (97.9%)</span>
            </div>
          </div>
          <p className="text-[12px] text-slate-500 mt-2 text-center">10 dari 11 opini buatan confidence &gt; 95%</p>
        </motion.div>
      </motion.div>
    </motion.div>
  );
